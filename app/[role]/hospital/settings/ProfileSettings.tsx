    ...
    >
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-default-500">Manage your organization information</p>
        </div>
        <Button
          color="primary"
          isLoading={isLoading}
        ...
        <CardBody className="flex flex-col md:flex-row gap-6 items-center p-6">
          <div className="relative">
            <Avatar
              ...
              showFallback
              name={`${formData.firstName || 'User'} ${formData.lastName || ''}`}
              fallback={
                <User
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-default-500">
              Upload a high-quality logo for your organization.
              JPG or PNG, max 2MB.
            </p>
          </div>
          <Button
      ...
      <Card>
        <CardHeader>
          <h3 className="text-lg font-semibold">Organization Preferences</h3>
        </CardHeader>
        <CardBody className="gap-4">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-default-500">Receive email updates about your organization</p>
              </div>
              <Switch
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="font-medium">Organization SMS</p>
                <p className="text-sm text-default-500">Receive text messages about your organization</p>
              </div>
              <Switch
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="font-medium">Organization Push</p>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalContent>
          <ModalHeader>Upload Organization Logo</ModalHeader>
          <ModalBody>
            <input
              type="file"
              accept="image/*"
