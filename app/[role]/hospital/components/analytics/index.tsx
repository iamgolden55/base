...
import PatientsConditions from '@/app/components/hospital-dashboard/patientsConditions';
import ClinicalOutcome from '@/app/components/hospital-dashboard/clinicalOutcome';
